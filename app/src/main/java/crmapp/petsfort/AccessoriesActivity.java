...
public class AccessoriesActivity extends AppCompatActivity {
	...
	private TimerTask t;
	private DatabaseReference accessories = _firebase.getReference("accessories");
	private ChildEventListener _accessories_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		edittext1.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				...
				accessories.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
		...
		_accessories_child_listener = new ChildEventListener() {
			@Override
		...
		accessories.addChildEventListener(_accessories_child_listener);
	}
