...
public class Frag6FragmentActivity extends Fragment {
	...
	private DatabaseReference top = _firebase.getReference("top");
	private ChildEventListener _top_child_listener;
	
	@NonNull
	@Override
	public View onCreateView(@NonNull LayoutInflater _inflater, @Nullable ViewGroup _container, @Nullable Bundle _savedInstanceState) {
		View _view = _inflater.inflate(R.layout.frag6_fragment, _container, false);
	...
	private void initialize(Bundle _savedInstanceState, View _view) {
		...
		_top_child_listener = new ChildEventListener() {
			@Override
		...
		top.addChildEventListener(_top_child_listener);
	}
	...
	private void initializeLogic() {
		...
		top.addListenerForSingleValueEvent(new ValueEventListener() {
			@Override
