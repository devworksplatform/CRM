...
public class Frag5FragmentActivity extends Fragment {
	...
	private DatabaseReference sweater = _firebase.getReference("sweater");
	private ChildEventListener _sweater_child_listener;
	...
	private void initialize(Bundle _savedInstanceState, View _view) {
		...
		_sweater_child_listener = new ChildEventListener() {
			@Override
		...
		sweater.addChildEventListener(_sweater_child_listener);
	}
	...
	private void initializeLogic() {
		...
		sweater.addListenerForSingleValueEvent(new ValueEventListener() {
			@Override
