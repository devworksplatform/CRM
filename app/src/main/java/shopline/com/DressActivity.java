...
public class DressActivity extends AppCompatActivity {
	...
	private TimerTask t;
	private DatabaseReference dress = _firebase.getReference("dress");
	private ChildEventListener _dress_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		edittext1.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				...
				dress.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
		...
		_dress_child_listener = new ChildEventListener() {
			@Override
		...
		dress.addChildEventListener(_dress_child_listener);
	}
