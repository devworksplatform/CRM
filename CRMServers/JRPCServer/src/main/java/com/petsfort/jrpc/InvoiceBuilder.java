...
final class InvoiceBuilder {
    ...
    static JsonObject create(String orderId,String created,String userId,JsonObject user,JsonArray products,
        ...
        buyer.addProperty("gstin",Jsons.optionalString(user,"gstin","N/A"));invoice.add("buyer",buyer);
        ...
        double grand=Jsons.round2(sub+cgst+sgst);JsonObject totals=new JsonObject();
        ...
        JsonObject words=new JsonObject();words.addProperty("amountChargeable",amountWords(grand));
    ...
    private static String amountWords(double value){return String.format(Locale.ENGLISH,"Rupees %.2f Only",value);}
}
